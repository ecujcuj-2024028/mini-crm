...
const handleRegister = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Error al registrar la cuenta. Intenta con otro correo.';
  } finally {
    loading.value = false;
  }
};
      ...
      <div class="lg:col-span-5 bg-[#263840] text-white p-5 sm:p-8 lg:p-14 flex flex-col justify-between relative overflow-hidden transition-all duration-300">
        ...
        >
          ...
          <p class="text-[#C4D3D9] text-xs sm:text-sm lg:text-base leading-relaxed mb-4 lg:mb-8 font-normal">
            Únete a tu equipo para colaborar en proyectos, gestionar tareas y aumentar tu productividad sin complicaciones.
          </p>
        ...
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-6">
            ...
            <p class="text-[#6E6E6E] text-xs sm:text-sm">
              Completa tus datos para registrar tu usuario en la plataforma.
            </p>
          </div>
          ...
          <form @submit.prevent="handleRegister" class="space-y-4">
            ...
            <!-- Botón Principal "Registrarme" (#5C7E8F) -->
            <AppButton
              type="submit"
              variant="primary"
              :loading="loading"
          ...
          <div class="mt-6 text-center text-xs sm:text-sm text-[#6E6E6E]">
            ¿Ya tienes cuenta?
            <router-link to="/login" class="text-[#5C7E8F] font-semibold hover:text-[#3D5A66] hover:underline transition-colors ml-1">
              Inicia sesión
            </router-link>
          </div>
        </div>
